...
from diffusion_policy.policy.bet_hybrid_image_policy import BETHybridImagePolicy
...
# %%
class TrainBETHybridImageWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf):
        ...
        # configure model
        self.policy: BETHybridImagePolicy
...
def main(cfg):
    workspace = TrainBETHybridImageWorkspace(cfg)
    workspace.run()
