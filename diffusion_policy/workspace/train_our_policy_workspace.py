...
from diffusion_policy.policy.our_policy import OurPolicy
...
5. train our model
"""
class TrainOurPolicyWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir = None):
        ...
        # configure model
        self.model: OurPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: OurPolicy = None
...
def main(cfg):
    workspace = TrainOurPolicyWorkspace(cfg)
    workspace.run()
