...
from diffusion_policy.policy.torch_model_policy import Torch_Model_Policy
...
class TrainTransformerForOursWorkspace(BaseWorkspace):
    def __init__(self, cfg: OmegaConf, output_dir = None):
        ...
        # configure policy
        self.policy: Torch_Model_Policy = hydra.utils.instantiate(cfg.policy)

        self.ema_policy: Torch_Model_Policy = None
            ...
            for local_epoch_idx in range(cfg.training.num_epochs):
                ...
                with tqdm.tqdm(train_dataloader, desc=f"Training epoch {self.epoch}",
                    ...
                    for batch_idx, batch in enumerate(tepoch):
                        ...
                        # compute loss
                        raw_loss = self.policy.compute_loss(batch=batch)
...
def main(cfg):
    workspace = TrainTransformerForOursWorkspace(cfg)
    workspace.run()
