"""
    COPY from https://github.com/lucidrains/robotic-transformer-pytorch
    A pytorch implementation version of RT-1
"""
...
class RT1(nn.Module):
    ...
    def get_optim_groups(self, weight_decay: float=1e-3):
        # seperate out all parameters to those that will and won't experience regularizing weight decay
        decay = list()
        no_decay = list()
    ...
    def configure_optimizers(self,
        ...
        optim_group = self.get_optim_groups(weight_decay=weight_decay)
    ...
    def forward(self,
                ...
                texts: Optional[List[str]] = None,
                cond_drop_prob = 0.):
        # video dim: [batch_size, chennels, frames, height, width]
